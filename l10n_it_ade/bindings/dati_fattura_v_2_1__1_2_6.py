...
class DatiFatturaHeaderType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __SpazioDatiFattura = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(
...
class DTEType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __CessionarioCommittenteDTE = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CessionarioCommittenteDTE'), 'CessionarioCommittenteDTE',
                                                                          '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev2_0_DTEType_CessionarioCommittenteDTE', True, pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 54, 6), )
...
class DTRType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __CessionarioCommittenteDTR = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'CessionarioCommittenteDTR'), 'CessionarioCommittenteDTR',
                                                                          '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev2_0_DTRType_CessionarioCommittenteDTR', False, pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 61, 6), )
...
class CedentePrestatoreDTEType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __AltriDatiIdentificativi = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'AltriDatiIdentificativi'), 'AltriDatiIdentificativi',
                                                                        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev2_0_CedentePrestatoreDTEType_AltriDatiIdentificativi', False, pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 78, 6), )
...
class CedentePrestatoreDTRType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element AltriDatiIdentificativi uses Python identifier AltriDatiIdentificativi
    __AltriDatiIdentificativi = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'AltriDatiIdentificativi'), 'AltriDatiIdentificativi',
                                                                        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev2_0_CedentePrestatoreDTRType_AltriDatiIdentificativi', False, pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 86, 6), )
...
class CessionarioCommittenteDTEType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element AltriDatiIdentificativi uses Python identifier AltriDatiIdentificativi
    __AltriDatiIdentificativi = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'AltriDatiIdentificativi'), 'AltriDatiIdentificativi',
                                                                        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev2_0_CessionarioCommittenteDTEType_AltriDatiIdentificativi', False, pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 95, 6), )
...
class CessionarioCommittenteDTRType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element AltriDatiIdentificativi uses Python identifier AltriDatiIdentificativi
    __AltriDatiIdentificativi = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'AltriDatiIdentificativi'), 'AltriDatiIdentificativi',
                                                                        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev2_0_CessionarioCommittenteDTRType_AltriDatiIdentificativi', False, pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 104, 6), )
...
DatiFattura = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DatiFattura'), DatiFatturaType,
                                         documentation='XML schema fatture emesse e ricevute ex D.Lgs. 127/205 (art.1, c.3) 2.1', location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 13, 2))
Namespace.addCategoryObject(
...
DatiFatturaHeaderType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ProgressivoInvio'), String10Type,
                                                             scope=DatiFatturaHeaderType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 37, 6)))
...
DatiFatturaHeaderType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Dichiarante'), DichiaranteType,
                                                             scope=DatiFatturaHeaderType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 38, 6)))
...
DatiFatturaHeaderType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdSistema'), CodiceFiscaleType,
                                                             scope=DatiFatturaHeaderType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 39, 6)))

DatiFatturaHeaderType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'SpazioDatiFattura'), pyxb.binding.datatypes.normalizedString,
                                                             scope=DatiFatturaHeaderType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 40, 6)))
...
DichiaranteType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CodiceFiscale'), CodiceFiscaleType,
                                                       scope=DichiaranteType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 46, 6)))

DichiaranteType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Carica'), CaricaType,
                                                       scope=DichiaranteType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 47, 6)))
...
DTEType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CedentePrestatoreDTE'), CedentePrestatoreDTEType,
                                               scope=DTEType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 53, 6)))

DTEType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CessionarioCommittenteDTE'),
                                               CessionarioCommittenteDTEType, scope=DTEType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 54, 6)))

DTEType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Rettifica'), RettificaType,
                                               scope=DTEType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 55, 6)))
...
def _BuildAutomaton_2():
    ...
    cc_0 = fac.CounterCondition(min=1, max=1000, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 54, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 55, 6))
    counters.add(cc_1)
    states = []
    final_update = None
...
DTRType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CessionarioCommittenteDTR'),
                                               CessionarioCommittenteDTRType, scope=DTRType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 61, 6)))
...
DTRType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CedentePrestatoreDTR'), CedentePrestatoreDTRType,
                                               scope=DTRType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 62, 6)))

DTRType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Rettifica'), RettificaType,
                                               scope=DTRType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 63, 6)))
...
def _BuildAutomaton_3():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=1, max=1000, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 62, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 63, 6))
    counters.add(cc_1)
    states = []
    final_update = None
...
ANNType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdFile'), String18Type,
                                               scope=ANNType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 69, 6)))

ANNType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Posizione'), PosizioneType,
                                               scope=ANNType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 70, 6)))
...
def _BuildAutomaton_4():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 70, 6))
    counters.add(cc_0)
    states = []
    final_update = set()
...
CedentePrestatoreDTEType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdentificativiFiscali'), IdentificativiFiscaliITType,
                                                                scope=CedentePrestatoreDTEType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 77, 6)))

CedentePrestatoreDTEType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'AltriDatiIdentificativi'), AltriDatiIdentificativiITType,
                                                                scope=CedentePrestatoreDTEType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 78, 6)))
...
def _BuildAutomaton_5():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 78, 6))
    counters.add(cc_0)
    states = []
    final_update = set()
...
CedentePrestatoreDTRType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdentificativiFiscali'), IdentificativiFiscaliType,
                                                                scope=CedentePrestatoreDTRType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 85, 6)))

CedentePrestatoreDTRType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'AltriDatiIdentificativi'), AltriDatiIdentificativiType,
                                                                scope=CedentePrestatoreDTRType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 86, 6)))
...
CedentePrestatoreDTRType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiFatturaBodyDTR'), DatiFatturaBodyDTRType,
                                                                scope=CedentePrestatoreDTRType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 87, 6)))
...
def _BuildAutomaton_6():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 85, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 86, 6))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=1, max=1000, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 87, 6))
    counters.add(cc_2)
    states = []
    final_update = None
...
CessionarioCommittenteDTEType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdentificativiFiscali'), IdentificativiFiscaliNoIVAType,
                                                                     scope=CessionarioCommittenteDTEType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 94, 6)))

CessionarioCommittenteDTEType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'AltriDatiIdentificativi'), AltriDatiIdentificativiType,
                                                                     scope=CessionarioCommittenteDTEType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 95, 6)))
...
CessionarioCommittenteDTEType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiFatturaBodyDTE'), DatiFatturaBodyDTEType,
                                                                     scope=CessionarioCommittenteDTEType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 96, 6)))
...
def _BuildAutomaton_7():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 94, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 95, 6))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=1, max=1000, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 96, 6))
    counters.add(cc_2)
    states = []
    final_update = None
...
CessionarioCommittenteDTRType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdentificativiFiscali'), IdentificativiFiscaliITType,
                                                                     scope=CessionarioCommittenteDTRType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 103, 6)))

CessionarioCommittenteDTRType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'AltriDatiIdentificativi'), AltriDatiIdentificativiITType,
                                                                     scope=CessionarioCommittenteDTRType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 104, 6)))
...
def _BuildAutomaton_8():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 104, 6))
    counters.add(cc_0)
    states = []
    final_update = set()
...
DatiFatturaBodyDTEType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiGenerali'), DatiGeneraliDTEType,
                                                              scope=DatiFatturaBodyDTEType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 110, 6)))
...
DatiFatturaBodyDTEType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiRiepilogo'), DatiRiepilogoType,
                                                              scope=DatiFatturaBodyDTEType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 111, 6)))
...
def _BuildAutomaton_9():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=1, max=1000, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 111, 6))
    counters.add(cc_0)
    states = []
    final_update = None
...
DatiFatturaBodyDTRType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiGenerali'), DatiGeneraliDTRType,
                                                              scope=DatiFatturaBodyDTRType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 117, 6)))
...
DatiFatturaBodyDTRType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiRiepilogo'), DatiRiepilogoType,
                                                              scope=DatiFatturaBodyDTRType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 118, 6)))
...
def _BuildAutomaton_10():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=1, max=1000, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 118, 6))
    counters.add(cc_0)
    states = []
    final_update = None
...
RettificaType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdFile'), String18Type,
                                                     scope=RettificaType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 124, 6)))

RettificaType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Posizione'), PosizioneType,
                                                     scope=RettificaType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 125, 6)))
...
IdentificativiFiscaliType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA'), IdFiscaleType,
                                                                 scope=IdentificativiFiscaliType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 131, 6)))
...
IdentificativiFiscaliType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CodiceFiscale'), CodiceFiscaleType,
                                                                 scope=IdentificativiFiscaliType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 132, 6)))
...
def _BuildAutomaton_12():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 132, 6))
    counters.add(cc_0)
    states = []
    final_update = set()
...
IdentificativiFiscaliITType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA'), IdFiscaleITType,
                                                                   scope=IdentificativiFiscaliITType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 138, 6)))
...
IdentificativiFiscaliITType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CodiceFiscale'), CodiceFiscaleType,
                                                                   scope=IdentificativiFiscaliITType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 139, 6)))
...
def _BuildAutomaton_13():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 139, 6))
    counters.add(cc_0)
    states = []
    final_update = set()
...
def _BuildAutomaton_14():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 145, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 146, 6))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
...
AltriDatiIdentificativiITType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(
...
AltriDatiIdentificativiITType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'StabileOrganizzazione'), IndirizzoType,
                                                                     scope=AltriDatiIdentificativiITType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 156, 3)))

AltriDatiIdentificativiITType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'RappresentanteFiscale'), RappresentanteFiscaleITType,
                                                                     scope=AltriDatiIdentificativiITType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 157, 3)))
...
def _BuildAutomaton_15():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 152, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 153, 6))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 154, 6))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 155, 6))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 156, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 157, 3))
    counters.add(cc_5)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(AltriDatiIdentificativiITType._UseForTag(pyxb.namespace.ExpandedName(
...
AltriDatiIdentificativiType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Denominazione'), String80LatinType,
                                                                   scope=AltriDatiIdentificativiType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 163, 6)))

AltriDatiIdentificativiType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(
...
AltriDatiIdentificativiType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'StabileOrganizzazione'), IndirizzoType,
                                                                   scope=AltriDatiIdentificativiType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 167, 3)))

AltriDatiIdentificativiType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'RappresentanteFiscale'), RappresentanteFiscaleType,
                                                                   scope=AltriDatiIdentificativiType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 168, 3)))
...
def _BuildAutomaton_16():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 163, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 164, 6))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 165, 6))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 166, 6))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 167, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 168, 3))
    counters.add(cc_5)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(AltriDatiIdentificativiType._UseForTag(pyxb.namespace.ExpandedName(
...
IndirizzoType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Indirizzo'), String60LatinType,
                                                     scope=IndirizzoType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 174, 6)))

IndirizzoType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'NumeroCivico'), NumeroCivicoType,
                                                     scope=IndirizzoType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 175, 6)))

IndirizzoType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'CAP'), CAPType,
                                                     scope=IndirizzoType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 176, 6)))

IndirizzoType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Comune'), String60LatinType,
                                                     scope=IndirizzoType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 177, 6)))

IndirizzoType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Provincia'), ProvinciaType,
                                                     scope=IndirizzoType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 178, 6)))

IndirizzoType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Nazione'), NazioneType,
                                                     scope=IndirizzoType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 179, 6)))
...
def _BuildAutomaton_17():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 174, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 175, 6))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 176, 6))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 177, 6))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 178, 6))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 179, 6))
    counters.add(cc_5)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
...
RappresentanteFiscaleType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA'), IdFiscaleType,
                                                                 scope=RappresentanteFiscaleType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 185, 6)))
...
RappresentanteFiscaleType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Denominazione'), String80LatinType,
                                                                 scope=RappresentanteFiscaleType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 186, 6)))

RappresentanteFiscaleType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Nome'), String60LatinType,
                                                                 scope=RappresentanteFiscaleType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 187, 6)))
...
RappresentanteFiscaleType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Cognome'), String60LatinType,
                                                                 scope=RappresentanteFiscaleType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 188, 6)))
...
def _BuildAutomaton_18():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 185, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 186, 6))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 187, 6))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 188, 6))
    counters.add(cc_3)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
...
RappresentanteFiscaleITType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA'), IdFiscaleITType,
                                                                   scope=RappresentanteFiscaleITType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 194, 6)))
...
RappresentanteFiscaleITType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Denominazione'), String80LatinType,
                                                                   scope=RappresentanteFiscaleITType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 195, 6)))
...
def _BuildAutomaton_19():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 194, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 195, 6))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 196, 6))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 197, 6))
    counters.add(cc_3)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
...
DatiGeneraliDTEType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'TipoDocumento'), TipoDocumentoType,
                                                           scope=DatiGeneraliDTEType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 203, 6)))

DatiGeneraliDTEType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Data'), DataFatturaType,
                                                           scope=DatiGeneraliDTEType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 204, 6)))

DatiGeneraliDTEType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Numero'), String20Type,
                                                           scope=DatiGeneraliDTEType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 205, 6)))
...
def _BuildAutomaton_20():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(DatiGeneraliDTEType._UseForTag(pyxb.namespace.ExpandedName(
...
DatiGeneraliDTRType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'TipoDocumento'), TipoDocumentoType,
                                                           scope=DatiGeneraliDTRType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 211, 6)))

DatiGeneraliDTRType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Data'), DataFatturaType,
                                                           scope=DatiGeneraliDTRType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 212, 6)))

DatiGeneraliDTRType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Numero'), String20Type,
                                                           scope=DatiGeneraliDTRType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 213, 6)))
...
DatiGeneraliDTRType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DataRegistrazione'), DataFatturaType,
                                                           scope=DatiGeneraliDTRType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 214, 6)))
...
def _BuildAutomaton_21():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 212, 6))
    counters.add(cc_0)
    states = []
    final_update = None
...
DatiRiepilogoType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ImponibileImporto'), Amount2DecimalType,
                                                         scope=DatiRiepilogoType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 220, 6)))

DatiRiepilogoType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiIVA'), DatiIVAType,
                                                         scope=DatiRiepilogoType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 221, 6)))

DatiRiepilogoType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Natura'), NaturaType,
                                                         scope=DatiRiepilogoType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 222, 6)))

DatiRiepilogoType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Detraibile'), RateType,
                                                         scope=DatiRiepilogoType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 223, 6)))

DatiRiepilogoType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Deducibile'), DeducibileType,
                                                         scope=DatiRiepilogoType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 224, 6)))
...
DatiRiepilogoType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'EsigibilitaIVA'), EsigibilitaIVAType,
                                                         scope=DatiRiepilogoType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 225, 6)))
...
def _BuildAutomaton_22():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 222, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 223, 6))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 224, 6))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 225, 6))
    counters.add(cc_3)
    states = []
    final_update = None
...
DatiIVAType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Imposta'), Amount2DecimalType,
                                                   scope=DatiIVAType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 231, 6)))

DatiIVAType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'Aliquota'), RateType,
                                                   scope=DatiIVAType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 232, 6)))
...
def _BuildAutomaton_23():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 231, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 232, 6))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
...
IdFiscaleType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdPaese'), NazioneType,
                                                     scope=IdFiscaleType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 238, 3)))

IdFiscaleType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdCodice'), CodiceType,
                                                     scope=IdFiscaleType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 239, 3)))
...
IdFiscaleITType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdPaese'), NazioneITType,
                                                       scope=IdFiscaleITType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 245, 3)))

IdFiscaleITType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'IdCodice'), CodiceIvaType,
                                                       scope=IdFiscaleITType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 246, 3)))
...
DatiFatturaType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DatiFatturaHeader'), DatiFatturaHeaderType,
                                                       scope=DatiFatturaType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 24, 6)))

DatiFatturaType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DTE'), DTEType,
                                                       scope=DatiFatturaType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 26, 5)))

DatiFatturaType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'DTR'), DTRType,
                                                       scope=DatiFatturaType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 27, 5)))

DatiFatturaType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'ANN'), ANNType,
                                                       scope=DatiFatturaType, location=pyxb.utils.utility.Location('../data/datifatture/DatiFatturav2.1.xsd', 28, 5)))
...
def _BuildAutomaton_26():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 24, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location(
        '../data/datifatture/DatiFatturav2.1.xsd', 30, 6))
    counters.add(cc_1)
    states = []
    final_update = None
