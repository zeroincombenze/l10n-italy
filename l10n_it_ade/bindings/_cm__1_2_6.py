...
# Generated
# 2019-03-07 08:00:44.782896 by PyXB version 1.2.6 using Python 2.7.5.final.0
...
class Identificativo_Type(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location("../data/common/fornitura_v3.xsd", 27, 1)
    _Documentation = None
...
# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoAN_Type
class DatoAN_Type(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location("../data/common/typesDati_v3.xsd", 15, 1)
...
# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoNU_Type
class DatoNU_Type(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location("../data/common/typesDati_v3.xsd", 23, 1)
...
DatoNU_Type._InitializeFacetMap(DatoNU_Type._CF_pattern, DatoNU_Type._CF_maxLength)
Namespace.addCategoryObject("typeBinding", "DatoNU_Type", DatoNU_Type)
_module_typeBindings.DatoNU_Type = DatoNU_Type

# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoPC_Type
class DatoPC_Type(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location("../data/common/typesDati_v3.xsd", 32, 1)
...
DatoPC_Type._InitializeFacetMap(DatoPC_Type._CF_pattern, DatoPC_Type._CF_maxLength)
Namespace.addCategoryObject("typeBinding", "DatoPC_Type", DatoPC_Type)
_module_typeBindings.DatoPC_Type = DatoPC_Type

# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoQU_Type
class DatoQU_Type(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location("../data/common/typesDati_v3.xsd", 41, 1)
...
DatoQU_Type._InitializeFacetMap(DatoQU_Type._CF_pattern, DatoQU_Type._CF_maxLength)
Namespace.addCategoryObject("typeBinding", "DatoQU_Type", DatoQU_Type)
_module_typeBindings.DatoQU_Type = DatoQU_Type

# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoVP_Type
class DatoVP_Type(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location("../data/common/typesDati_v3.xsd", 50, 1)
...
DatoVP_Type._InitializeFacetMap(DatoVP_Type._CF_pattern, DatoVP_Type._CF_maxLength)
Namespace.addCategoryObject("typeBinding", "DatoVP_Type", DatoVP_Type)
_module_typeBindings.DatoVP_Type = DatoVP_Type

# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoN1_Type
class DatoN1_Type(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location("../data/common/typesDati_v3.xsd", 59, 1)
...
DatoN1_Type._InitializeFacetMap(DatoN1_Type._CF_pattern, DatoN1_Type._CF_maxLength)
Namespace.addCategoryObject("typeBinding", "DatoN1_Type", DatoN1_Type)
_module_typeBindings.DatoN1_Type = DatoN1_Type

# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoNP_Type
class DatoNP_Type(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location("../data/common/typesDati_v3.xsd", 68, 1)
    _Documentation = (
        "Tipo semplice che identifica numeri naturali positivi con al massimo 16 cifre."
    )
...
# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoPI_Type
class DatoPI_Type(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location("../data/common/typesDati_v3.xsd", 76, 1)
...
DatoPI_Type._InitializeFacetMap(DatoPI_Type._CF_pattern, DatoPI_Type._CF_length)
Namespace.addCategoryObject("typeBinding", "DatoPI_Type", DatoPI_Type)
_module_typeBindings.DatoPI_Type = DatoPI_Type

# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoCN_Type
class DatoCN_Type(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location("../data/common/typesDati_v3.xsd", 85, 1)
...
DatoCN_Type._InitializeFacetMap(DatoCN_Type._CF_pattern, DatoCN_Type._CF_length)
Namespace.addCategoryObject("typeBinding", "DatoCN_Type", DatoCN_Type)
_module_typeBindings.DatoCN_Type = DatoCN_Type

# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoCF_Type
class DatoCF_Type(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location("../data/common/typesDati_v3.xsd", 94, 1)
...
# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoCB_Type
...
# Atomic simple
# type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoCB12_Type
...
# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoDT_Type
...
DatoDT_Type._InitializeFacetMap(DatoDT_Type._CF_pattern, DatoDT_Type._CF_length)
Namespace.addCategoryObject("typeBinding", "DatoDT_Type", DatoDT_Type)
_module_typeBindings.DatoDT_Type = DatoDT_Type

# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoDA_Type
...
DatoDA_Type._InitializeFacetMap(DatoDA_Type._CF_pattern, DatoDA_Type._CF_length)
Namespace.addCategoryObject("typeBinding", "DatoDA_Type", DatoDA_Type)
_module_typeBindings.DatoDA_Type = DatoDA_Type

# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoDN_Type
...
DatoDN_Type._InitializeFacetMap(DatoDN_Type._CF_pattern, DatoDN_Type._CF_length)
Namespace.addCategoryObject("typeBinding", "DatoDN_Type", DatoDN_Type)
_module_typeBindings.DatoDN_Type = DatoDN_Type

# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoD6_Type
...
DatoD6_Type._InitializeFacetMap(DatoD6_Type._CF_pattern, DatoD6_Type._CF_length)
Namespace.addCategoryObject("typeBinding", "DatoD6_Type", DatoD6_Type)
_module_typeBindings.DatoD6_Type = DatoD6_Type

# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoEM_Type
...
# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoGA_Type
...
DatoGA_Type._InitializeFacetMap(
    DatoGA_Type._CF_minLength, DatoGA_Type._CF_maxLength, DatoGA_Type._CF_pattern
)
...
# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoTL_Type
...
# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}DatoCP_Type
...
# Atomic simple
# type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}ProvincieItaliane
class ProvincieItaliane(
...
# Atomic simple
# type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}ProvincieCroate
class ProvincieCroate(
    pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin
):
...
# Atomic
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}Estero
...
# Union
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}PR_Type
...
PR_Type._InitializeFacetMap(PR_Type._CF_pattern, PR_Type._CF_enumeration)
Namespace.addCategoryObject("typeBinding", "PR_Type", PR_Type)
_module_typeBindings.PR_Type = PR_Type

# Union
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}PN_Type
# superclasses pyxb.binding.datatypes.anySimpleType
...
PN_Type._InitializeFacetMap(PN_Type._CF_pattern, PN_Type._CF_enumeration)
Namespace.addCategoryObject("typeBinding", "PN_Type", PN_Type)
_module_typeBindings.PN_Type = PN_Type

# Union
# simple type: {urn:www.agenziaentrate.gov.it:specificheTecniche:common}PE_Type
# superclasses pyxb.binding.datatypes.anySimpleType
...
PE_Type._InitializeFacetMap(PE_Type._CF_pattern, PE_Type._CF_enumeration)
Namespace.addCategoryObject("typeBinding", "PE_Type", PE_Type)
_module_typeBindings.PE_Type = PE_Type

# Complex type
# {urn:www.agenziaentrate.gov.it:specificheTecniche:common}Documento_Type with content type EMPTY
class Documento_Type(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location("../data/common/fornitura_v3.xsd", 21, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType

    # Attribute identificativo uses Python identifier identificativo
    __identificativo = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, "identificativo"),
        "identificativo",
        "__urnwww_agenziaentrate_gov_itspecificheTecnichecommon_Documento_Type_identificativo",
        _module_typeBindings.Identificativo_Type,
        required=True,
    )
    ...
    _ElementMap.update({})
    _AttributeMap.update({__identificativo.name(): __identificativo})
...
Documento = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "Documento"),
    Documento_Type,
    abstract=pyxb.binding.datatypes.boolean(1),
    location=pyxb.utils.utility.Location("../data/common/fornitura_v3.xsd", 20, 1),
)
