...
_module_typeBindings.Identificativo_Type = IdentificativoType
...
_module_typeBindings.DatoAN_Type = DatoANType
...
DatoNUType._InitializeFacetMap(DatoNU_Type._CF_pattern,
                               DatoNUType._CF_maxLength)
Namespace.addCategoryObject('typeBinding', 'DatoNU_Type', DatoNUType)
_module_typeBindings.DatoNU_Type = DatoNUType
...
DatoPCType._CF_maxLength = pyxb.binding.facets.CF_maxLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(16))
DatoPCType._InitializeFacetMap(DatoPC_Type._CF_pattern,
                               DatoPCType._CF_maxLength)
Namespace.addCategoryObject('typeBinding', 'DatoPC_Type', DatoPCType)
_module_typeBindings.DatoPC_Type = DatoPCType
...
DatoQUType._CF_maxLength = pyxb.binding.facets.CF_maxLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(16))
DatoQUType._InitializeFacetMap(DatoQU_Type._CF_pattern,
                               DatoQUType._CF_maxLength)
Namespace.addCategoryObject('typeBinding', 'DatoQU_Type', DatoQUType)
_module_typeBindings.DatoQU_Type = DatoQUType
...
DatoVPType._CF_maxLength = pyxb.binding.facets.CF_maxLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(16))
DatoVPType._InitializeFacetMap(DatoVP_Type._CF_pattern,
                               DatoVPType._CF_maxLength)
Namespace.addCategoryObject('typeBinding', 'DatoVP_Type', DatoVPType)
_module_typeBindings.DatoVP_Type = DatoVPType
...
DatoN1Type._InitializeFacetMap(DatoN1_Type._CF_pattern,
                               DatoN1Type._CF_maxLength)
Namespace.addCategoryObject('typeBinding', 'DatoN1_Type', DatoN1Type)
_module_typeBindings.DatoN1_Type = DatoN1Type
...
_module_typeBindings.DatoNP_Type = DatoNPType
...
_module_typeBindings.DatoCF_Type = DatoCFType
...
_module_typeBindings.DatoCB_Type = DatoCBType
...
_module_typeBindings.DatoCB12_Type = DatoCB12Type
...
_module_typeBindings.DatoEM_Type = DatoEMType
...
_module_typeBindings.DatoTL_Type = DatoTLType
...
_module_typeBindings.DatoCP_Type = DatoCPType
...
_module_typeBindings.PR_Type = PRType
...
_module_typeBindings.PN_Type = PNType
...
_module_typeBindings.PE_Type = PEType
...
class DocumentoType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __identificativo = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(
        None, 'identificativo'), 'identificativo', '__urnwww_agenziaentrate_gov_itspecificheTecnichecommon_Documento_Type_identificativo', _module_typeBindings.Identificativo_Type, required=True)
...
_module_typeBindings.Documento_Type = DocumentoType
