...
# Generated 2019-02-18 23:13:40.047102 by PyXB version 1.2.5 using Python 2.7.5.final.0
...
DatoVN_Type._InitializeFacetMap(DatoVN_Type._CF_maxLength, DatoVN_Type._CF_pattern)
...
class CTD_ANON_(pyxb.binding.basis.complexTypeDefinition):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location(
        "/opt/odoo/tmp/data/common/liquidazione/fornituraIvp_2017_v1.xsd", 23, 2
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __Intestazione = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location(
            "/opt/odoo/tmp/data/common/liquidazione/fornituraIvp_2017_v1.xsd", 25, 4
        ),
    )
    ...
    __Comunicazione = pyxb.binding.content.ElementDeclaration(
        ...
        False,
        pyxb.utils.utility.Location(
            "/opt/odoo/tmp/data/common/liquidazione/fornituraIvp_2017_v1.xsd", 26, 4
        ),
    )
...
Fornitura = pyxb.binding.basis.element(
    ...
    CTD_ANON_,
    location=pyxb.utils.utility.Location(
        "/opt/odoo/tmp/data/common/liquidazione/fornituraIvp_2017_v1.xsd", 22, 1
    ),
)
...
def _BuildAutomaton_3():
    ...
    cc_0 = fac.CounterCondition(
        ...
        max=1,
        metadata=pyxb.utils.utility.Location(
            "/opt/odoo/tmp/data/common/liquidazione/fornituraIvp_2017_v1.xsd", 27, 4
        ),
    )
    counters.add(cc_0)
    states = []
