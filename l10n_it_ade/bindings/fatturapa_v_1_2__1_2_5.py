...
FormatoTrasmissioneType._InitializeFacetMap(
    FormatoTrasmissioneType._CF_length, FormatoTrasmissioneType._CF_enumeration
)
Namespace.addCategoryObject(
...
TipoScontoMaggiorazioneType._InitializeFacetMap(
    TipoScontoMaggiorazioneType._CF_length, TipoScontoMaggiorazioneType._CF_enumeration
)
Namespace.addCategoryObject(
...
Art73Type._InitializeFacetMap(Art73Type._CF_length, Art73Type._CF_enumeration)
...
TipoCassaType._InitializeFacetMap(
    TipoCassaType._CF_length, TipoCassaType._CF_enumeration
)
...
TipoDocumentoType._InitializeFacetMap(
    TipoDocumentoType._CF_length, TipoDocumentoType._CF_enumeration
)
...
TipoRitenutaType._InitializeFacetMap(
    TipoRitenutaType._CF_length, TipoRitenutaType._CF_enumeration
)
...
SoggettoEmittenteType._InitializeFacetMap(
    SoggettoEmittenteType._CF_length, SoggettoEmittenteType._CF_enumeration
)
Namespace.addCategoryObject(
...
RegimeFiscaleType._InitializeFacetMap(
    RegimeFiscaleType._CF_length, RegimeFiscaleType._CF_enumeration
)
...
ModalitaPagamentoType._InitializeFacetMap(
    ModalitaPagamentoType._CF_length, ModalitaPagamentoType._CF_enumeration
)
Namespace.addCategoryObject(
...
RitenutaType._InitializeFacetMap(RitenutaType._CF_length, RitenutaType._CF_enumeration)
...
CodEORIType._InitializeFacetMap(CodEORIType._CF_minLength, CodEORIType._CF_maxLength)
...
TipoCessionePrestazioneType._InitializeFacetMap(
    TipoCessionePrestazioneType._CF_length, TipoCessionePrestazioneType._CF_enumeration
)
Namespace.addCategoryObject(
...
EmailType._InitializeFacetMap(
    EmailType._CF_minLength, EmailType._CF_maxLength, EmailType._CF_pattern
)
...
RateType._InitializeFacetMap(RateType._CF_pattern)  # RateType._CF_maxInclusive,
...
class IndirizzoType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __CAP = pyxb.binding.content.ElementDeclaration(
        ...
        "CAP",
        "__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_" "IndirizzoType_CAP",
        False,
        pyxb.utils.utility.Location(
            "http://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/"
            "v1.2/Schema_del_file_xml_FatturaPA_versione_1.2.xsd",
...
class ContattiType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __Fax = pyxb.binding.content.ElementDeclaration(
        ...
        "Fax",
        "__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_" "ContattiType_Fax",
        False,
        pyxb.utils.utility.Location(
            "http://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/"
            "v1.2/Schema_del_file_xml_FatturaPA_versione_1.2.xsd",
