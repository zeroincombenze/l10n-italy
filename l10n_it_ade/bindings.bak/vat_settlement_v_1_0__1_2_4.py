...
# Generated 2022-09-27 15:27:19.903602 by PyXB version 1.2.4 using Python 2.7.18.final.0
...
class Eventi_Ecc_Type(pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 141, 1)
    _Documentation = None
...
class STD_ANON(_ImportedBinding__cm.DatoNP_Type, pyxb.binding.basis.enumeration_mixin):
    """An atomic simple type."""
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 27, 4)
    _Documentation = None
...
class STD_ANON_(_ImportedBinding__cm.DatoNP_Type, pyxb.binding.basis.enumeration_mixin):
    """An atomic simple type."""
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 49, 4)
    _Documentation = None
...
class STD_ANON_2(_ImportedBinding__cm.DatoN1_Type, pyxb.binding.basis.enumeration_mixin):
    """An atomic simple type."""
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 72, 4)
    _Documentation = None
...
class STD_ANON_3(_ImportedBinding__cm.DatoNP_Type, pyxb.binding.basis.enumeration_mixin):
    """An atomic simple type."""
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 91, 7)
    _Documentation = None
...
class STD_ANON_4(_ImportedBinding__cm.DatoN1_Type, pyxb.binding.basis.enumeration_mixin):
    """An atomic simple type."""
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 109, 7)
    _Documentation = None
...
class STD_ANON_5(_ImportedBinding__cm.DatoAN_Type, pyxb.binding.basis.enumeration_mixin):
    """An atomic simple type."""
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../data/common/liquidazione/intestazioneIvp_2017_v1.xsd', 14, 4)
    _Documentation = None
...
class STD_ANON_6(_ImportedBinding__cm.DatoNP_Type, pyxb.binding.basis.enumeration_mixin):
    """An atomic simple type."""
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../data/common/liquidazione/intestazioneIvp_2017_v1.xsd', 22, 4)
    _Documentation = None
...
class Frontespizio_IVP_Type(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 20, 1)
    _ElementMap = {}
    _AttributeMap = {}
...
class DatiContabili_IVP_Type(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 85, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class CTD_ANON(pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 88, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class CTD_ANON_(pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('../data/common/liquidazione/fornituraIvp_2017_v1.xsd', 23, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class Comunicazione_IVP_Type(_ImportedBinding__cm.Documento_Type):
    ...
    _XSDLocation = pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 10, 1)
...
Intestazione = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Intestazione'), pyxb.binding.datatypes.anyType, location=pyxb.utils.utility.Location('../data/common/liquidazione/intestazioneIvp_2017_v1.xsd', 10, 1))
Namespace.addCategoryObject('elementBinding', Intestazione.name().localName(), Intestazione)
Fornitura = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Fornitura'), CTD_ANON_, location=pyxb.utils.utility.Location('../data/common/liquidazione/fornituraIvp_2017_v1.xsd', 22, 1))
Namespace.addCategoryObject('elementBinding', Fornitura.name().localName(), Fornitura)
Comunicazione = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Comunicazione'), Comunicazione_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 9, 1))
Namespace.addCategoryObject('elementBinding', Comunicazione.name().localName(), Comunicazione)
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CodiceFiscale'), _ImportedBinding__cm.DatoCF_Type, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 22, 3)))
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'AnnoImposta'), _ImportedBinding__cm.DatoDA_Type, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 23, 3)))
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'PartitaIVA'), _ImportedBinding__cm.DatoPI_Type, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 24, 3)))
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'PIVAControllante'), _ImportedBinding__cm.DatoPI_Type, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 25, 3)))
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'UltimoMese'), STD_ANON, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 26, 3)))
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'LiquidazioneGruppo'), _ImportedBinding__cm.DatoCB_Type, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 46, 3)))
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CFDichiarante'), _ImportedBinding__cm.DatoCF_Type, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 47, 3)))
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CodiceCaricaDichiarante'), STD_ANON_, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 48, 3)))
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CodiceFiscaleSocieta'), _ImportedBinding__cm.DatoCN_Type, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 68, 3)))
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'FirmaDichiarazione'), _ImportedBinding__cm.DatoCB_Type, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 69, 3)))
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CFIntermediario'), _ImportedBinding__cm.DatoCF_Type, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 70, 3)))
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ImpegnoPresentazione'), STD_ANON_2, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 71, 3)))
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DataImpegno'), _ImportedBinding__cm.DatoDT_Type, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 79, 3)))
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'FirmaIntermediario'), _ImportedBinding__cm.DatoCB_Type, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 80, 3)))
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'FlagConferma'), _ImportedBinding__cm.DatoCB_Type, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 81, 3)))
Frontespizio_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'IdentificativoProdSoftware'), _ImportedBinding__cm.DatoAN_Type, scope=Frontespizio_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 82, 3)))
def _BuildAutomaton():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 25, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 26, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 46, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 47, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 48, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 68, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 70, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 71, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 79, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 80, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 81, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 82, 3))
    counters.add(cc_11)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CodiceFiscale')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 22, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'AnnoImposta')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 23, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'PartitaIVA')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 24, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'PIVAControllante')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 25, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'UltimoMese')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 26, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'LiquidazioneGruppo')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 46, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CFDichiarante')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 47, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CodiceCaricaDichiarante')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 48, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CodiceFiscaleSocieta')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 68, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'FirmaDichiarazione')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 69, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CFIntermediario')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 70, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ImpegnoPresentazione')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 71, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DataImpegno')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 79, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'FirmaIntermediario')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 80, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'FlagConferma')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 81, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(Frontespizio_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IdentificativoProdSoftware')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 82, 3))
...
DatiContabili_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Modulo'), CTD_ANON, scope=DatiContabili_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 87, 3)))
def _BuildAutomaton_():
    ...
    import pyxb.utils.fac as fac
    counters = set()
    cc_0 = fac.CounterCondition(min=1, max=5, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 87, 3))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(DatiContabili_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Modulo')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 87, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
...
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Mese'), STD_ANON_3, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 90, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Trimestre'), STD_ANON_4, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 108, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Subfornitura'), _ImportedBinding__cm.DatoCB_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 119, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'EventiEccezionali'), Eventi_Ecc_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 120, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TotaleOperazioniAttive'), DatoVN_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 121, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TotaleOperazioniPassive'), DatoVN_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 122, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'IvaEsigibile'), DatoVN_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 123, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'IvaDetratta'), DatoVN_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 124, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'IvaDovuta'), _ImportedBinding__cm.DatoVP_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 125, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'IvaCredito'), _ImportedBinding__cm.DatoVP_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 126, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DebitoPrecedente'), _ImportedBinding__cm.DatoVP_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 127, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CreditoPeriodoPrecedente'), _ImportedBinding__cm.DatoVP_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 128, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CreditoAnnoPrecedente'), DatoVN_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 129, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'VersamentiAutoUE'), _ImportedBinding__cm.DatoVP_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 130, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CreditiImposta'), _ImportedBinding__cm.DatoVP_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 131, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'InteressiDovuti'), _ImportedBinding__cm.DatoVP_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 132, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Acconto'), _ImportedBinding__cm.DatoVP_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 133, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ImportoDaVersare'), _ImportedBinding__cm.DatoVP_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 134, 6)))
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ImportoACredito'), _ImportedBinding__cm.DatoVP_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 135, 6)))
def _BuildAutomaton_2():
    ...
    import pyxb.utils.fac as fac
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 90, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 108, 6))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 119, 6))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 120, 6))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 121, 6))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 122, 6))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 123, 6))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 124, 6))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 125, 6))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 126, 6))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 127, 6))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 128, 6))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 129, 6))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 130, 6))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 131, 6))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 132, 6))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 133, 6))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 134, 6))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 135, 6))
    counters.add(cc_18)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Mese')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 90, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Trimestre')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 108, 6))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Subfornitura')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 119, 6))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'EventiEccezionali')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 120, 6))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'TotaleOperazioniAttive')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 121, 6))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'TotaleOperazioniPassive')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 122, 6))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IvaEsigibile')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 123, 6))
    st_6 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IvaDetratta')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 124, 6))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IvaDovuta')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 125, 6))
    st_8 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IvaCredito')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 126, 6))
    st_9 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DebitoPrecedente')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 127, 6))
    st_10 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CreditoPeriodoPrecedente')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 128, 6))
    st_11 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CreditoAnnoPrecedente')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 129, 6))
    st_12 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'VersamentiAutoUE')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 130, 6))
    st_13 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CreditiImposta')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 131, 6))
    st_14 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'InteressiDovuti')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 132, 6))
    st_15 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Acconto')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 133, 6))
    st_16 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ImportoDaVersare')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 134, 6))
    st_17 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ImportoACredito')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 135, 6))
...
CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Intestazione'), Intestazione_IVP_Type, scope=CTD_ANON_, location=pyxb.utils.utility.Location('../data/common/liquidazione/fornituraIvp_2017_v1.xsd', 25, 4)))
CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Comunicazione'), Comunicazione_IVP_Type, scope=CTD_ANON_, location=pyxb.utils.utility.Location('../data/common/liquidazione/fornituraIvp_2017_v1.xsd', 26, 4)))
def _BuildAutomaton_3():
    ...
    import pyxb.utils.fac as fac
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/fornituraIvp_2017_v1.xsd', 27, 4))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Intestazione')), pyxb.utils.utility.Location('../data/common/liquidazione/fornituraIvp_2017_v1.xsd', 25, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Comunicazione')), pyxb.utils.utility.Location('../data/common/liquidazione/fornituraIvp_2017_v1.xsd', 26, 4))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(_Namespace_ds, 'Signature')), pyxb.utils.utility.Location('../data/common/liquidazione/fornituraIvp_2017_v1.xsd', 27, 4))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
Intestazione_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CodiceFornitura'), STD_ANON_5, scope=Intestazione_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/intestazioneIvp_2017_v1.xsd', 13, 3)))
Intestazione_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CodiceFiscaleDichiarante'), _ImportedBinding__cm.DatoCF_Type, scope=Intestazione_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/intestazioneIvp_2017_v1.xsd', 20, 3)))
Intestazione_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CodiceCarica'), STD_ANON_6, scope=Intestazione_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/intestazioneIvp_2017_v1.xsd', 21, 3)))
Intestazione_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'IdSistema'), _ImportedBinding__cm.DatoCF_Type, scope=Intestazione_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/intestazioneIvp_2017_v1.xsd', 41, 3)))
def _BuildAutomaton_4():
    ...
    import pyxb.utils.fac as fac
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/intestazioneIvp_2017_v1.xsd', 20, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/intestazioneIvp_2017_v1.xsd', 21, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('../data/common/liquidazione/intestazioneIvp_2017_v1.xsd', 41, 3))
    counters.add(cc_2)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(Intestazione_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CodiceFornitura')), pyxb.utils.utility.Location('../data/common/liquidazione/intestazioneIvp_2017_v1.xsd', 13, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(Intestazione_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CodiceFiscaleDichiarante')), pyxb.utils.utility.Location('../data/common/liquidazione/intestazioneIvp_2017_v1.xsd', 20, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(Intestazione_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CodiceCarica')), pyxb.utils.utility.Location('../data/common/liquidazione/intestazioneIvp_2017_v1.xsd', 21, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(Intestazione_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IdSistema')), pyxb.utils.utility.Location('../data/common/liquidazione/intestazioneIvp_2017_v1.xsd', 41, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
Comunicazione_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Frontespizio'), Frontespizio_IVP_Type, scope=Comunicazione_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 14, 5)))
Comunicazione_IVP_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DatiContabili'), DatiContabili_IVP_Type, scope=Comunicazione_IVP_Type, location=pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 15, 5)))
def _BuildAutomaton_5():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(Comunicazione_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Frontespizio')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 14, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(Comunicazione_IVP_Type._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DatiContabili')), pyxb.utils.utility.Location('../data/common/liquidazione/comunicazioneIvp_2017_v1.xsd', 15, 5))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_1, [
