...
.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy/9.0/l10n_it_ade/static/description/icon.png
...
`l10n_it_ade <https://github.com/zeroincombenze/l10n-italy/tree/9.0/l10n_it_ade>`__ come dipendenza.
...
``run_odoo_debug 9.0 -um l10n_it_ade -s -d MYDB``
