...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/l10n-italy/7.0/l10n_it_ade/static/src/img/icon.png
...
`l10n_it_ade <https://github.com/Odoo-Italia-Associazione/l10n-italy/tree/7.0/l10n_it_ade>`__ come dipendenza.
...
``run_odoo_debug 7.0 -um l10n_it_ade -s -d MYDB``
