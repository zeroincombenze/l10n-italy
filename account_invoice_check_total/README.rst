...
==================================
|icon| Account Invoice Check Total
==================================


**Check if the verification total is equal to the bill's total**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy/10.0/account_invoice_check_total/static/description/icon.png
...
|en| Account Invoice Check Total
---------------------------
...
|it| Verifica totale fatture fornitori
---------------------------------
...
* |menu| Setting > Apps |right_do| Select **account_invoice_check_total** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **account_invoice_check_total** > Update
...
Last Update / Ultimo aggiornamento: 2019-02-24
