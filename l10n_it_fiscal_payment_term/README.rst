=================================================================
|icon| Fiscal payment term/l10n_it_fiscal_payment_term 10.0.1.0.1
=================================================================
...
|en| E-Invoice and FatturaPA Payment Terms as per
`Italian Government Website <http://fatturapa.gov.it>`__


|it| Termini di pagamento fiscali per Fattura Elettronica e FatturaPA come da
`Disposizioni governative FatturaPA <http://fatturapa.gov.it>`__


|thumbnail|

.. |thumbnail| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy/10.0/l10n_it_fiscal_payment_term/static/description/
