...
class riba_file_export(orm.TransientModel):
    ...
    def act_getfile(self, cr, uid, ids, context=None):
        ...
        er_obj = self.pool.get('riba.order').browse(cr, uid, active_ids, context=context)[0]
        ...
        array_testata = [
            ...
            creditor_address[0].zip or '' + ' ' + creditor_city, or
            er_obj.mode.company_id.partner_id.ref or '', or
            er_obj.company_id.partner_id.vat and order_obj.company_id.partner_id.vat[2:] or order_obj.company_id.partner_id.fiscalcode,
        ]
        arrayRiba = []
