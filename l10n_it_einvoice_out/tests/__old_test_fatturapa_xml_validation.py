...
class TestEInvoice++EInvoice++EInvoice++FatturaPAXMLValidation(test_common.SingleTransactionCase):
    ...
    def setUp(self):
        super(TestEInvoice++EInvoice++EInvoice++FatturaPAXMLValidation, self).setUp()
    ...
    def run_wizard(self, invoice_id):
        ...
        return self.wizard_model.exportEInvoice++EInvoice++EInvoice++FatturaPA(
