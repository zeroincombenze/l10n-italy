...
* Written on 2022-09-27 14:20:38.639825 by mk_test_env 10.0.0.7.5
"""
import logging
...
TEST_RES_PARTNER = {
    ...
    "z0bug.res_partner_8": {
        ...
        "street": "Via Madonna delle Guardia, 88",
        "property_payment_term_id": "z0bug.payment_1",
        "city": "Roma",
        "zip": "00195",
        "country_id": "base.it",
        "property_account_position_id": "z0bug.fiscalpos_sp",
        "supplier": False,
        ...
        "phone": "+39 06 5556666",
        "customer": True,
        "name": "Global Solution F8 s.r.l.",
        "is_company": True,
        "state_id": "base.state_it_rm",
...
TEST_ACCOUNT_INVOICE = {
    ...
    "z0bug.invoice_Z0_3": {
        ...
        "date_invoice": "2022-08-31",
        "partner_bank_id": "z0bug.bank_company_1",
        "partner_id": "z0bug.res_partner_8",
        "fiscal_position_id": "z0bug.fiscalpos_it",
    },
}
