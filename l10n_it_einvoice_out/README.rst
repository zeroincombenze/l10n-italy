...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/l10n-italy/11.0/l10n_it_einvoice_out/static/description/icon.png
...
``run_odoo_debug 11.0 -um l10n_it_einvoice_out -s -d MYDB``
