...
.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze//8.0//static/description/icon.png
...
::
    ...
    deploy_odoo clone -r  -b 8.0 -G zero -p $HOME/8.0
    # Upgrade virtual environment
    vem amend $HOME/8.0/venv_odoo

From UI: go to:

* |menu| Setting > Modules > Update Modules List
* |menu| Setting > Local Modules |right_do| Select **** > Install
...
::
    ...
    deploy_odoo update -r  -b 8.0 -G zero -p $HOME/8.0
    vem amend $HOME/8.0/venv_odoo
...
* |menu| Setting > Modules > Update Modules List
* |menu| Setting > Local Modules |right_do| Select **** > Update
...
8.0.3.2.3 (2023-06-29)
~~~~~~~~~~~~~~~~~~~~~~

* [FIX] Copy invoice / Errore in copia fattura
* [QUA] Test coverage 15% (585: 495+90) 
...
.. |Maturity| image:: https://img.shields.io/badge/maturity-Alfa-black.png
    ...
    :alt: 
.. |Build Status| image:: https://travis-ci.org/zeroincombenze/.svg?branch=8.0
...
.. |license opl| image:: https://img.shields.io/badge/licence-OPL-7379c3.svg
    ...
    :alt: License: OPL
.. |Coverage Status| image:: https://coveralls.io/repos/github/zeroincombenze//badge.svg?branch=8.0
    :target: https://coveralls.io/github/zeroincombenze/?branch=8.0
    :alt: Coverage
.. |Codecov Status| image:: https://codecov.io/gh/zeroincombenze//branch/8.0/graph/badge.svg
    :target: https://codecov.io/gh/zeroincombenze//branch/8.0
    :alt: Codecov
...
.. |Try Me| image:: https://www.zeroincombenze.it/wp-content/uploads/ci-ct/prd/button-try-it-8.svg
    ...
    :alt: Try Me
.. |OCA Codecov| image:: https://codecov.io/gh/OCA//branch/8.0/graph/badge.svg
    :target: https://codecov.io/gh/OCA//branch/8.0
    :alt: Codecov
