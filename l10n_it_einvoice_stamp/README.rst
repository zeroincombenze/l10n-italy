...
=================================================
|icon| Italian Localization - Tax Stamp 8.0.1.0.1
=================================================


**Tax stamp automatic management**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy/8.0/l10n_it_einvoice_stamp/static/description/icon.png
...
* |menu| Setting > Local Modules |right_do| Select **l10n_it_einvoice_stamp** > Install
...
* |menu| Setting > Modules > Update Modules List
* |menu| Setting > Local Modules |right_do| Select **l10n_it_einvoice_stamp** > Update
