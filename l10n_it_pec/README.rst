...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/l10n-italy/8.0/l10n_it_pec/static/description/icon.png
...
``run_odoo_debug 8.0 -um l10n_it_pec -s -d MYDB``
