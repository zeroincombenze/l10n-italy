...
=================================
|icon| ITA - Email PEC 14.0.1.0.0
=================================


**Aggiunge il campo email PEC al partner**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy/14.0/l10n_it_pec/static/description/icon.png
...
::
    ...
    deploy_odoo clone -r l10n-italy -b 14.0 -G zero -p $HOME/14.0
...
::
    ...
    deploy_odoo update -r l10n-italy -b 14.0 -G zero -p $HOME/14.0
    vem amend $HOME/14.0/venv_odoo
...
.. |Maturity| image:: https://img.shields.io/badge/maturity-Alfa-black.png
    ...
    :alt: 
.. |Build Status| image:: https://travis-ci.org/zeroincombenze/l10n-italy.svg?branch=14.0
...
.. |license opl| image:: https://img.shields.io/badge/licence-OPL-7379c3.svg
    ...
    :alt: License: OPL
.. |Coverage Status| image:: https://coveralls.io/repos/github/zeroincombenze/l10n-italy/badge.svg?branch=14.0
    :target: https://coveralls.io/github/zeroincombenze/l10n-italy?branch=14.0
    :alt: Coverage
.. |Codecov Status| image:: https://codecov.io/gh/zeroincombenze/l10n-italy/branch/14.0/graph/badge.svg
    :target: https://codecov.io/gh/zeroincombenze/l10n-italy/branch/14.0
    :alt: Codecov
...
.. |Try Me| image:: https://www.zeroincombenze.it/wp-content/uploads/ci-ct/prd/button-try-it-14.svg
    ...
    :alt: Try Me
.. |OCA Codecov| image:: https://codecov.io/gh/OCA/l10n-italy/branch/14.0/graph/badge.svg
    :target: https://codecov.io/gh/OCA/l10n-italy/branch/14.0
    :alt: Codecov
