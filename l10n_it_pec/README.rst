...
.. |icon| image:: https://raw.githubusercontent.com/Odoo-Italia-Associazione/l10n-italy/7.0/l10n_it_pec/static/src/img/icon.png
...
``run_odoo_debug 7.0 -um l10n_it_pec -s -d MYDB``
