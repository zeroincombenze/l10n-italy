...
=================================================
|icon| Italian Localization - Email PEC 8.0.0.1.0
=================================================
...
::
    ...
    deploy_odoo clone -r l10n-italy -b 8.0 -G zero -p $HOME/8.0
...
::
    ...
    deploy_odoo update -r l10n-italy -b 8.0 -G zero -p $HOME/8.0
    vem amend $HOME/8.0/venv_odoo
