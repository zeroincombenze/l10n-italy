...
.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy/9.0/l10n_it_fiscal_ipa/static/description/icon.png
...
.. |Codecov Status| image:: https://codecov.io/gh/zeroincombenze/l10n-italy/branch/9.0/graph/badge.svg
    ...
    :alt: Codecov
.. |OCA project| image:: http://www.zeroincombenze.it/wp-content/uploads/ci-ct/prd/button-oca-9.svg
    :target: https://github.com/OCA/l10n-italy/tree/9.0
    :alt: OCA
.. |Tech Doc| image:: http://www.zeroincombenze.it/wp-content/uploads/ci-ct/prd/button-docs-9.svg
    :target: http://wiki.zeroincombenze.org/en/Odoo/9.0/dev
    :alt: Technical Documentation
.. |Help| image:: http://www.zeroincombenze.it/wp-content/uploads/ci-ct/prd/button-help-9.svg
    :target: http://wiki.zeroincombenze.org/it/Odoo/9.0/man
    :alt: Technical Documentation
.. |Try Me| image:: http://www.zeroincombenze.it/wp-content/uploads/ci-ct/prd/button-try-it-9.svg
