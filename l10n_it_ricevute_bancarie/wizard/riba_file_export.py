...
class riba_file_export(orm.TransientModel):
    ...
    def act_getfile(self, cr, uid, ids, context=None):
        ...
        er_obj = self.pool['riba.distinta'].browse(cr, uid, active_ids, context=context)[0]
        ...
        array_testata = [
            ...
            creditor_address[0].zip and creditor_address[0].zip.replace('x', '0')[0:5] or '' + ' ' + creditor_city, or
