    ...
    ***************************************************************************
    ...
    def _Record40(
        ...
        return (
            ...
            + unidecode(self._comune_provincia_debitor)
    ...
    def _Record51(self, numero_ricevuta_creditore):
        return (
            ...
            + unidecode(self._creditore)[0:20]
            + " " * 80
            + "\r\n"
        )
    ...
    def act_getfile(self):
        ...
        if (
            ...
            raise UserError(_("No VAT or Fiscalcode specified for: ") + name_company)
        array_testata = [
            credit_sia,
            credit_abi,
            credit_cab,
