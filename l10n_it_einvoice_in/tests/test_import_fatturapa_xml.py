...
class TestFatturaPAXMLValidation(FatturapaCommon):
    ...
    def __test_22_xml_import(self):
        ...
        self.assertEqual(payment_data[0].payment_methods[0].penalty_date, "2015-05-01")
