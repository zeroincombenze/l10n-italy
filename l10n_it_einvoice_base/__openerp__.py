...
#
{
    ...
    'license': 'AGPL-3',
    'depends': ['l10n_it_ade', 'account', 'l10n_it_fiscalcode', 'document', 'l10n_it_fiscal_ipa', 'l10n_it_rea', 'base_iban', 'l10n_it_ade', 'l10n_it_fiscal_payment_term'],
    'data': ['security/ir.model.access.csv', 'data/fatturapa_fiscal_position.xml', 'data/fatturapa_data.xml', 'data/welfare.fund.type.xml', 'views/account_view.xml', 'views/company_view.xml', 'views/regime_fiscale_view.xml', 'views/fiscal_position_view.xml'],
    'installable': True,
