=========================================================================
|icon| Italian Localization - Account/Localizzazione italiana 10.0.1.2.14
=========================================================================
...
|en| Technical module that supplies some structures usable by other modules like
...
|it| Modulo tecnico che fornisce alcune strutture utilizzabili da altri moduli
...
.. |thumbnail| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy/10.0/l10n_it_account/static/description/description.png
